...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/callab/Documents/Labwork/Joe/psychopy-eyes/10:25_test_lastrun.py',
...
instructions = visual.TextStim(win=win, name='instructions',
    text='INSTRUCTIONS:\n\n\nA sentence will appear at the center of the screen.\r\n\n\nAfter you have read the sentence on the screen, please press the space button.\r\n\n\rPlease focus on the cross that will then appear at the center of the screen.\r\n\n\rAfter a red box appears around the cross, hit the space bar to go on to the next sentence.\r\n\n\rYou should read as quickly as possible while still understanding the sentence. Please read these sentences for comprehension, as you will be asked questions on their content.\n\nPlease press the "f" key for yes or the "j" key for no on the comprehension questions. Take your time answering these questions as you will be scored on your number correct. ',
    font='Arial',
